                    ...
                    {sections.length === 0 ? (
                      ...
                      sections.map((section) => (
                        <div key={section.id} id={`section-${section.id}`}>
                          ...
                          {section.content && (
                            <p className="text-sm text-foreground/80 whitespace-pre-wrap leading-relaxed mb-3">{section.content}</p>
                          )}
                          {section.children?.map((child) => (
                            <div key={child.id} className="ml-4 mt-3" id={`section-${child.id}`}>
                              ...
                              {child.content && (
                                <p className="text-sm text-foreground/80 whitespace-pre-wrap leading-relaxed">{child.content}</p>
                              )}
                              {child.children?.map((sub) => (
                                <div key={sub.id} className="ml-4 mt-2" id={`section-${sub.id}`}>
                                  ...
                                  {sub.content && (
                                    <p className="text-xs text-foreground/80 whitespace-pre-wrap leading-relaxed">{sub.content}</p>
                                  )}
                                </div>
                              ))}
                            </div>

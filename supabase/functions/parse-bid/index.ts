...
10. **投标截止时间 (bid_deadline)**：提取投标截止日期和时间，返回ISO 8601格式。如果文档中没有明确说明，返回null。
11. **投标/开标地点 (bid_location)**：提取投标或开标地点。如果文档中没有明确说明，返回null。
12. **是否讲标 (requires_presentation)**：判断是否要求讲标/现场演示/答辩。返回true/false，未明确则返回null。
13. **投标保证金 (deposit_amount)**：提取投标保证金金额。如果文档中没有明确说明，返回null。
